...
def trade61():
    ...
    double_bottom_tickers = [
        ticker for ticker in tickers if prices[ticker][4] < prices[ticker][2] == prices[ticker][0] < prices[ticker][1] and prices[ticker][3] > prices[ticker][2]
    ]
...
def trade63():
    ...
    hs_bottom_tickers = [
        ticker for ticker in tickers if prices[ticker][6] > prices[ticker][5] < prices[ticker][4] > prices[ticker][3] < prices[ticker][2] and prices[ticker][1] < prices[ticker][0]
    ]
...
def trade65():
    ...
    bullish_flag_tickers = [
        ticker
        for ticker in tickers
        if prices[ticker][9] < prices[ticker][8]
        and all(prices[ticker][i] < prices[ticker][i + 1] for i in range(8, 4, -1))
        and all(prices[ticker][i] > prices[ticker][i + 1] for i in range(4, 0, -1))
    ]
...
def trade67():
    ...
    ascending_triangle_tickers = [
        ticker
        for ticker in tickers
        if prices[ticker][14] < prices[ticker][13] and prices[ticker][0] > prices[ticker][7] and all(prices[ticker][i] <= prices[ticker][i + 1] for i in range(13))
    ]
...
def trade69():
    ...
    rounding_bottom_tickers = [
        ticker
        for ticker in tickers
        if all(prices[ticker][i] >= prices[ticker][i + 1] for i in range(10)) and all(prices[ticker][i] <= prices[ticker][i + 1] for i in range(10, 19))
    ]
...
def trade119():
    ...
    market_total = [sum(prices[ticker][i] for ticker in tickers) for i in range(20)]
    scipy.stats.linregress(range(20), market_total).slope
